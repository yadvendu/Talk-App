...
class FirebaseRemoteExecutorImpl(private val firebaseAuth: FirebaseAuth) : FireBaseRemoteExecutor {
        ...
        return Single.create { emitter ->
            firebaseAuth.signInWithEmailAndPassword(
                ...
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        emitter.onSuccess(FireBaseResponse.FirebaseSuccessResponse(it.isSuccessful as T))
                    } else {
                        emitter.onSuccess(FireBaseResponse.FireBaseErrorResponse(it.isSuccessful as T))
                    }
                }
        }
    }
